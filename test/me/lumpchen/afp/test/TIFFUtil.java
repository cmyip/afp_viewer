...
public class TIFFUtil {
	...
	/**
	 * Updates the given ImageIO metadata with Sun's custom TIFF tags, as
	 ...
	 * sources</a>, the <a href=
	 * "http://download.java.net/media/jai-imageio/javadoc/1.0_01/com/sun/media/imageio/plugins/tiff/package-summary.html">
	 * com.sun.media.imageio.plugins.tiff package javadoc</a> and the
	 * <a href="http://partners.adobe.com/public/developer/tiff/index.html">TIFF
	 * specification</a>.
	 *
	 * @param image
	...
	static void updateMetadata(IIOMetadata metadata, BufferedImage image, int dpi) throws IIOInvalidTreeException {
		if (!MetaUtil.SUN_TIFF_FORMAT.equals(metadata.getNativeMetadataFormatName())) {
			LOG.debug("Using unknown TIFF image writer: " + metadata.getNativeMetadataFormatName());
			return;
		}

		IIOMetadataNode root = new IIOMetadataNode(MetaUtil.SUN_TIFF_FORMAT);
		IIOMetadataNode ifd;
		...
		metadata.mergeTree(MetaUtil.SUN_TIFF_FORMAT, root);
	}
