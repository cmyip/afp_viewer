...
public class ImageIOUtil {
	 ...
	 * {@link #writeImage(BufferedImage image, String formatName, OutputStream output, int dpi, float quality)}
	 * for more details.
	 *
	 * @param image
	 *            the image to be written
	 * @param filename
	 *            used to construct the filename for the individual image. Its
	 ...
	 *            the image to be written
	 * @param formatName
	 *            the target format (ex. "png") which is also the suffix for the
	 *            filename
	 * @param filename
	 *            used to construct the filename for the individual image. The
	 *            formatName parameter will be used as the suffix.
	 * @param dpi
	 *            the resolution in dpi (dots per inch) to be used in metadata
	 * @return true if the image file was produced, false if there was an error.
	 * @throws IOException
	 ...
	 *            the resolution in dpi (dots per inch) to be used in metadata
	 * @param quality
	 *            quality to be used when compressing the image (0 &lt; quality
	 *            &lt; 1.0f)
	 * @return true if the image file was produced, false if there was an error.
	 * @throws IOException
	 *             if an I/O error occurs
