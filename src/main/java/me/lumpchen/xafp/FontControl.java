...
public class FontControl extends AFPObject {
	...
	protected PatTech patTech;

	protected int FntFlags;
	...
	protected MeasureUnit xUnitBase;
	protected MeasureUnit yUnitBase;
	 ...
	 * */
	protected int xUnitsPerUnitBase;
	protected int yUnitsPerUnitBase;

	protected int MaxBoxWd;
	protected int MaxBoxHt;
	protected int FNORGLen;
	protected int FNIRGLen;
	 ...
	 * */
	protected int patternDataAlignment;
	protected int rasterPatternDataCount;

	protected int FNPRGLen;
	protected int FNMRGLen;

	protected List<Triplet> triplets;

	protected int ResXUBase;

	protected int ResYUBase;

	protected int xShapeResolution;

	protected int yShapeResolution;

	protected long OPatDCnt;

	protected int FNNRGLen;

	protected long FNNDCnt;

	protected int FNNMapCnt;
